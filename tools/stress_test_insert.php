...
function insertNotificationRules(PDO $db, int $sid, string $schoolName, bool $isPro): int {
    $rules = [
        ...
        [
            ...
            'body'    => "Αγαπητέ/ή {{athlete_name}},\n\nΗ συνδρομή σας λήγει ΣΗΜΕΡΑ ({{valid_until}}).\nΠοσό: {{amount}}€\n\nΠαρακαλούμε ανανεώστε άμεσα.\n\nΜε εκτίμηση,\n{$schoolName}",
        ],
        [
            ...
            'body'    => "Αγαπητέ/ή {{athlete_name}}, η συνδρομή σας έχει λήξει ({{valid_until}}). Ποσό: {{amount}}€. Παρακαλούμε τακτοποιήστε. {$schoolName}",
        ],
        [
            ...
            'ch'      => 'email,sms',
            'subj'    => "Εκκρεμής πληρωμή — {$schoolName}",
            'body'    => "Αγαπητέ/ή {{athlete_name}},\n\nΗ συνδρομή σας έχει λήξει εδώ και 10 μέρες.\nΠοσό: {{amount}}€\n\nΠαρακαλούμε τακτοποιήστε την πληρωμή σας το συντομότερο.\n\nΜε εκτίμηση,\n{$schoolName}",
        ],
        [
