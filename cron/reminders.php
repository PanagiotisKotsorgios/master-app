...
function cronBuildDefaultBody(string $triggerType, array $athlete, array $sub, string $schoolName): string {
    ...
    return match($triggerType) {
        'days_before' => "Αγαπητέ/ή κηδεμόνα,\n\nΗ συνδρομή του/της {$name} λήγει στις {$date}.\nΠαρακαλούμε φροντίστε για την έγκαιρη ανανέωση.\n\nΜε εκτίμηση,\n{$schoolName}",
        'on_due' => "Αγαπητέ/ή κηδεμόνα,\n\nΗ συνδρομή του/της {$name} λήγει σήμερα ({$date}).\nΠαρακαλούμε προχωρήστε σε ανανέωση.\n\nΜε εκτίμηση,\n{$schoolName}",
        'days_after' => "Αγαπητέ/ή κηδεμόνα,\n\nΗ συνδρομή του/της {$name} έχει λήξει από {$date}.\n" . ($debtDetail ?: "Οφειλή: {$amount}") . "\n\nΠαρακαλούμε τακτοποιήστε την πληρωμή.\n\nΜε εκτίμηση,\n{$schoolName}",
        'after_payment' => "Αγαπητέ/ή κηδεμόνα,\n\nΛάβαμε την πληρωμή για τον/την {$name}.\nΠοσό: {$amount}\n\nΕυχαριστούμε!\n{$schoolName}",
        'has_debt' => "Αγαπητέ/ή κηδεμόνα,\n\nΣας ενημερώνουμε ότι υπάρχει εκκρεμής οφειλή για τη συνδρομή του/της {$name}.\n" . ($debtDetail ?: "Οφειλόμενο ποσό: {$amount}") . "\n\nΠαρακαλούμε τακτοποιήστε την πληρωμή το συντομότερο δυνατό.\n\nΜε εκτίμηση,\n{$schoolName}",
        default => "Αγαπητέ/ή κηδεμόνα,\n\nΠαρακαλούμε δείτε την ενημέρωσή σας.\n\n{$schoolName}",
    };
}
